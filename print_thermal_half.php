<?php
/**
 * Thermal Print Template Page (Half Layout - Top Aligned)
 *
 * Displays a label formatted for thermal printers using only half of the paper width.
 * This version aligns all content to the top, leaving empty space at the bottom.
 * Adheres to PSR-12.
 *
