...
<head>
    ...
    <style>
        ...
        .label-print-container-thermal {
            position: relative; width: <?php echo $thermalPaperWidthMM; ?>mm; height: <?php echo $thermalPaperHeightMM; ?>mm; 
            padding: 0; box-sizing: border-box; display: flex; overflow: hidden; 
            background-color: #fff !important; margin: 0; page-break-after: always;
        }
        .label-print-container-thermal:last-child { page-break-after: auto; }
        .cutting-line { position: absolute; left: 50%; top: 0; bottom: 0; border-left: 1px dashed #9ca3af; }
        .layout-half {
        ...
        .separator-line { width: 90%; height: 0.5px; background-color: #6b7280; margin: 0.5mm auto; flex-shrink: 0; }
        .main-content-area { display: flex; flex-direction: column; width: 100%; overflow: hidden; }
        .qr-code-container-thermal {
            text-align: center; margin-bottom: 1mm;
            width: 100%; flex-shrink: 0;
        }
        .qr-code-container-thermal img { max-width: 100%; max-height: calc(<?php echo $thermalPaperHeightMM/2; ?>mm); height: auto; object-fit: contain; display: block; margin: 0 auto; }
        ...
        .reprint-watermark-vertical { position: absolute; top: 2mm; right: 0.5mm; writing-mode: vertical-rl; transform: rotate(180deg); font-size: 6pt; font-weight: bold; color: rgba(0, 0, 0, 0.4); text-transform: uppercase; letter-spacing: 0.5px; pointer-events: none; }
